...
<div class="content_resize">
  <div class="mainbar">
    ...
    <div class="article">
      ...
      <div class="clr"></div>
      <div class="img"><img src="<%=request.getContextPath() %>/template/public/images/doi-thay.jpg" width="177" height="213" alt="Đổi thay" class="fl" /></div>
    ...
    <div class="article">
      ...
      <div class="clr"></div>
      <div class="img"><img src="<%=request.getContextPath() %>/template/public/images/only-love.jpg" width="177" height="213" alt="Only Love" class="fl" /></div>
      <div class="post_content">
    ...
    <div class="article">
      ...
      <div class="clr"></div>
      <div class="img"><img src="<%=request.getContextPath() %>/template/public/images/noi-ay-con-tim-ve.jpg" width="177" height="213" alt="Nơi ấy con tìm về" class="fl" /></div>
      <div class="post_content">
